...
Any of the above-specified fields can be used to search for variables in combination with one another.  For example, suppose we want to search for all the variables from the "Year 1" wave that have "Mother" listedd as the respondent.  To accomplish this, we would call `search_metadata()` like so:
